...
// HAL_TIM_ACTIVE_CHANNEL_CLEARED  = 0x00    /*!< All active channels cleared */    
	...
	tim_init1.Init.ClockDivision = TIM_CLOCKDIVISION_DIV4;
	tim_init1.Init.Prescaler = 10;
	tim_init1.Init.Period = TIMER_PERIOD_1KHZ;
	...
	tim_init2.Init.ClockDivision = TIM_CLOCKDIVISION_DIV4;
	tim_init2.Init.Prescaler = 10;
	tim_init2.Init.Period = TIMER_PERIOD_1KHZ;
	...
	tim2_conf2.Pulse = 6000; // our duty cycle setting point
	...
	tim_init3.Init.ClockDivision = TIM_CLOCKDIVISION_DIV4;
	tim_init3.Init.Prescaler = 10;
	tim_init3.Init.Period = TIMER_PERIOD_1KHZ;
	...
	tim2_conf3.Pulse = 6000; // our duty cycle setting point
	...
	tim_init4.Init.ClockDivision = TIM_CLOCKDIVISION_DIV4;
	tim_init4.Init.Prescaler = 10;
	tim_init4.Init.Period = TIMER_PERIOD_1KHZ;
	...
	tim2_conf4.Pulse = 6000; // our duty cycle setting point
